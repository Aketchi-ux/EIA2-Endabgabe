namespace Main {
    ...
    window.addEventListener("load", async () => {
        ...
        let createQuery: URLSearchParams = new URLSearchParams();// creates a query string to send to the server
    ...
    function createFireworksButton(id : string) 
    {
        ...
        saveing.addEventListener("click", async () => {
            ...
            let query: URLSearchParams = new URLSearchParams();//creates URL parameters (query) to send a request to the server
